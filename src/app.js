(function(){
    var fs          = require("fs"),
        ...
        REMOTES     = win.REMOTES || [], 
        tray        = win.tray || null,
        initialized = win.app_initialzed || false;


    // Check if menu/window binding are already defined
    if (!initialized) {
        win.app_initialzed = true;
        startup();
    }

    /**
     * Startup GUI, add trayicon, bind events
     */
    function startup(){
